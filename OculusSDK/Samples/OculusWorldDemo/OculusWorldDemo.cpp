...
OculusWorldDemoApp::OculusWorldDemoApp() :
    ...
    DiscreteEyePoses{},
    DiscreteRotationThresholdAngle(10.0f),
    DiscreteRotationFovGrowMult(1.0f),
...
void OculusWorldDemoApp::PopulateOptionMenu()
{
    ...
    */
    ...
    Menu.AddBool("Render Target.Discete Rotation.Enable",             &DiscreteHmdRotationEnable).SetNotify(this, &OWD::HmdSettingChange);
    Menu.AddFloat("Render Target.Discete Rotation.Threshold Angle",   &DiscreteRotationThresholdAngle, 0.0f, 30.0f, 0.01f).SetNotify(this, &OWD::HmdSettingChange);
    Menu.AddFloat("Render Target.Discete Rotation.Debug FOV Growth Mult",   &DiscreteRotationFovGrowMult, -10.0f, 10.0f, 0.01f).SetNotify(this, &OWD::HmdSettingChange);
...
ovrResult OculusWorldDemoApp::CalculateHmdValues()
{
    ...
    if (DiscreteHmdRotationEnable)
    {
      ...
      fovGrowAngle *= DiscreteRotationFovGrowMult;
